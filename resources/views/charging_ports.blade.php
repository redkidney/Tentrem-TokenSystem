...
<body class="bg-gray-100 min-h-screen flex flex-col justify-center p-4">
    ...
    <div class="flex flex-col md:flex-row space-y-4 md:space-y-0 md:space-x-4">
        ...
        <!-- Charging Port 1 -->
        <div x-data="chargingStation(1)" class="w-full md:w-1/2 bg-white shadow-lg rounded-lg p-6">
            ...
            <form @submit.prevent="handleFormSubmit" class="space-y-4">
                ...
                <div class="grid grid-cols-3 gap-4">
                    ...
                    <!-- Clear, Zero, Submit -->
                    <button type="button" @click="clearToken()" class="bg-red-200 py-2 rounded-md text-center col-span-1">Clear</button>
                    <button type="button" @click="addToToken('0')" class="bg-gray-200 py-2 rounded-md text-center col-span-1">0</button>
                    <button type="submit" :disabled="token.length < 5" class="bg-green-500 text-white py-2 rounded-md col-span-1">Submit</button>
                </div>
            </form>
        ...
        <!-- Charging Port 2 -->
        <div x-data="chargingStation(2)" class="w-full md:w-1/2 bg-white shadow-lg rounded-lg p-6">
            ...
            return {
                ...
                handleFormSubmit() {
                    if (this.token.length === 5) {
                        ...
                        // Call API to validate and start charging (replace with your actual route)
